...
import api from '../services/api';
// import '../styles/Dashboard.css';
// import '../assets/scss/dashboard.scss'  // ⬅️ SCSS import yahan use kar sakte ho
        ...
        <div className="dashboard-shell">
          <div className="dashboard-container">
            ...
            <div className="access-info admin-info">
              <h3>📋 Access Information</h3>
              <p>
                You have full administrative access to all system features and can manage all aspects
                of the HRMS application.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="dashboard-page">
        ...
        <div className="dashboard-shell">
          <div className="dashboard-container">
            ...
            <div className="dashboard-grid">
              <div
                className="dashboard-card hr-card clickable-card"
                onClick={() => handleCardClick('employees')}
              >
                <div className="card-icon">👥</div>
                <div className="card-content">
            ...
            <div className="access-info hr-info">
              <h3>📋 Access Information</h3>
              <p>
                You have access to HR operations including employee management, leave approvals,
      ...
      <div className="dashboard-page">
        ...
        <div className="dashboard-shell">
          <div className="dashboard-container">
            ...
            <div className="dashboard-grid">
              <div
                className="dashboard-card manager-card clickable-card"
            ...
            <div className="access-info manager-info">
              <h3>📋 Access Information</h3>
              <p>
                You have access to team management features including viewing team data, approving
                leave requests, and tracking attendance.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="dashboard-page">
        ...
        <div className="dashboard-shell">
          <div className="dashboard-container">
            ...
            <div className="dashboard-grid">
              <div
                className="dashboard-card employee-card clickable-card"
                onClick={() => handleCardClick('profile')}
              >
                <div className="card-icon">👤</div>
                <div className="card-content">
            ...
            <div className="access-info employee-info">
              <h3>📋 Access Information</h3>
              <p>
                You have access to your personal information, leave management, attendance records,
                and payroll information. Leave requests are sent to HR for approval.
              </p>
            </div>
          </div>
        </div>
